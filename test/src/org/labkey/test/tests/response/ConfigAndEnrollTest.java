...
@Category({Git.class})
public class ConfigAndEnrollTest extends BaseResponseTest
{
    ...
    public void testEnroll()
    {
        ...
        _containerHelper.createProject(PROJECT_NAME04, FOLDER_TYPE);
        ...
        _containerHelper.createProject(PROJECT_NAME05, FOLDER_TYPE);
