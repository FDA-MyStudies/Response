...
import org.labkey.test.data.response.AbstractQuestionResponse;
...
import org.labkey.test.data.response.MedForm;
...
@Category({Git.class})
public class StudyWithdrawTest extends BaseResponseTest
{
    ...
    void setupProjects()
    {
        ...
        myStudiesResponseServerTab.setInputId(STUDY_NAME);
