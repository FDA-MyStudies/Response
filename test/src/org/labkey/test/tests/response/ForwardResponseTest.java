...
@Category({Git.class})
public class ForwardResponseTest extends BaseResponseTest
{
    ...
    private final static String MOCKSERVER_CALL_MATCHER_CLASS = MockServerPostCallback.class.getName();
